...
namespace Project3.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        {
            var sem3DBContext = _context.OrderDetails.Include(o => o.Orders).Include(o => o.Product);
        ...
        {
            ViewData["OrdersId"] = new SelectList(_context.Orders, "OrdersId", "ReceiverAddress");
        ...
        public async Task<IActionResult> Create([Bind("OrderDetailId,Quantity,TotalPrice,OrderDetailStatus,ProductId,OrdersId")] OrderDetail orderDetail)
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.Products, "ProductId", "Description", orderDetail.ProductId);
            return View(orderDetail);
        }
