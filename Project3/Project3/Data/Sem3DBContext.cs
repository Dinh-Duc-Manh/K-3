        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
         ...
         new
         {
            ...
            modelBuilder.Entity<Comment>().HasData(
              ...
              {
                  CommentId = 1,
                  Content = "hdgguighestaurifdfehwheijbjzmbvnnjguyrgggrhykiljhftyktstshttnmvcxe",
              ...
              {
                  CommentId = 2,
                  Content = "tetdhrfyykilieqerwteyurtiyoufdstouhiusrurhjjrirxuirytyyruiertfweudfesayygdfyeafgheuyufuyuesyeuueugbhtygthghhghjgguughhuuvyhcjnnnai",
                  CommentDate = DateTime.Now,
                  NewsId = 2,
                  AccountId = 2
