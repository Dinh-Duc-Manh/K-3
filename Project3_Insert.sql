...
Product Benefits	Digestive Health Support, Immune Support', 'anh.jpg', 'In stock', 1);
...
Product Benefits	Provides bloating and gas relief', 'anh.jpg', 'In stock', 1);
...
Product Benefits	Headache, Menstrual Pain, Joint Pain Relief, Backache, Fever', 'anh.jpg', 'In stock', 2);
...
Item Dimensions LxWxH	6 x 5 x 4 inches
Product Benefits	Back Pain Relief', 'anh.jpg', 'In stock', 2);
...
Specific Uses For Product	Cold', 'anh.jpg', 'In stock', 3);
...
Product Benefits	Cold and Flu Control', 'anh.jpg', 'In stock', 3);
...
Brand	AmScope
Objective Lens Description	Achromatic', 'anh.jpg', 'In stock', 4);
...
Model Name	BM27
Band Size	16.5 inch', 'anh.jpg', 'In stock', 5);
...
Band Size	12.6 inch
Material Feature	Durable', 'anh.jpg', 'In stock', 5);
...
Battery Description	Lithium-Ion', 'anh.jpg', 'In stock', 6);
...
Circular No. 14/2020/TT-BYT dated July 10, 2020 of the Minister of Health regulating a number of contents in bidding for medical equipment at public medical facilities.', 'anh.jpg', 'Science');
go
select * from News
go
INSERT INTO Account VALUES ('Admin','admin@gmail.com', 'admin', '0912345678', N'Tòa Nhà HTC-250 Hoàng Quốc Việt-Cổ Nhuế-Cầu Giấy-Hà Nội', 'anh.jpg', 'In force', 0);
INSERT INTO Account VALUES ('User','user@gmail.com', 'user', '0987654321', N'Tòa Nhà HTC-250 Hoàng Quốc Việt-Cổ Nhuế-Cầu Giấy-Hà Nội', 'anh.jpg', 'Disable', 1);
go
select * from Account
go
